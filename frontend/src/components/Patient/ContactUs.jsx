...
function ContactUs() {
  ...
  return (
    <section
        ...
        className="h-screen w-screen bg-[#ADD8E6]">
      <Navbar />
      <motion.div 
      ref={ref}
      initial={{ opacity: 0 }} 
      ...
      whileInView={{ opacity: 1 }}
       className="h-screen w-screen flex justify-center items-center pt-24">
        <div className="flex gap-10 mx-14 py-14">
          ...
          transition={{ duration: 1.5 }}
          whileInView={{ opacity: 1 }}
           className="flex flex-col w-[500px] h-4/5 p-4 justify-center items-center bg-[#fff] gap-10 border border-black broder-2 rounded-lg border-transparent shadow-xl shadow-slate-950">
